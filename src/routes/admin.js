...
// ⚡ Bolt: Cache prepared statements at the module level to avoid recompilation overhead
const getAdminStatsStmt = db.prepare(`
    SELECT
...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Combine 6 sequential scalar subqueries into a single round trip to SQLite
    const stats = getAdminStatsStmt.get();
