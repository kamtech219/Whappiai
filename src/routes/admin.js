...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Single optimized query for global platform stats
    // Replaces 6 sequential queries with 1, significantly reducing I/O and JS/C++ boundary crossing overhead
