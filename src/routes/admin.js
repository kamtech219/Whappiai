...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // This replaces 6 separate sequential queries with one, reducing I/O and compilation overhead.
    ...
    const totalCreditsDeducted = statsRow.totalCreditsDeducted || 0;
    const totalCreditsPurchased = statsRow.totalCreditsPurchased || 0;
