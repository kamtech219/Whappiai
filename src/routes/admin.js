...
// ⚡ Bolt: Cache prepared statements at module scope to avoid recompilation overhead
...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Fetch global stats in a single optimized query with subselects
    // This replaces 6 sequential DB calls, drastically reducing JS/C++ boundary-crossing overhead.
