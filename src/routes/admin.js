...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // 2. User & Session & Financial Statistics Bundled Optimization
    // Bundling multiple unrelated global aggregations into a single subquery reduces SQLite
    // sequential compilation overhead and I/O round trips considerably.
