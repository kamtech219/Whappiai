...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Batched 6 sequential database queries into a single query using subselects to reduce SQLite/JS boundary overhead
    // 2-4. Batched User, Session & Financial Statistics
