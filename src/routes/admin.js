...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Consolidated independent aggregate queries into a single query with subselects
    // This reduces sequential I/O roundtrips significantly compared to 6 separate db.prepare().get() calls.
