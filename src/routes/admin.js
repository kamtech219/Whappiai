...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // 2-4. Combined Database Aggregations
    // Bolt: Bundled 6 independent aggregations into a single query to reduce SQLite parsing overhead
    ...
    return response.success(res, {
        ...
        sessions: {
            total: dbStats.totalSessions,
            connected: dbStats.connectedSessions
        },
        credits: {
            deducted: dbStats.totalCreditsDeducted,
            purchased: dbStats.totalCreditsPurchased
        },
        ai: aiStats
    });
}));
