...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // 2-4. Combined Statistics
    // ⚡ Bolt: Bundled 6 independent aggregate queries into a single SQLite query using subselects to minimize I/O and JS boundary crossing overhead.
