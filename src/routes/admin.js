...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Combine 6 sequential scalar queries into a single query using sub-selects.
    // This reduces JS/C++ boundary-crossing overhead and SQLite sequential I/O.
    // We also use COALESCE(SUM(amount), 0) to safely handle empty tables in SQL instead of JS '|| 0'.
    ...
    const { totalUsers, activeUsers, totalSessions, connectedSessions, totalCreditsDeducted, totalCreditsPurchased } = stats;
