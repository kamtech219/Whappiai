...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Single optimized query for global stats using sub-selects
    // This reduces sequentially executing 6 separate database queries crossing the JS/C++ boundary into 1.
    ...
    const connectedSessions = globalStats.connectedSessions;

    // 4. Financial/Credit Statistics
    const totalCreditsDeducted = globalStats.totalCreditsDeducted;
    const totalCreditsPurchased = globalStats.totalCreditsPurchased;
