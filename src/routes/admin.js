...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // 2, 3, 4. Bundled Statistics (Users, Sessions, Credits)
    // ⚡ Bolt Optimization: Grouped multiple independent scalar queries into a single bundled SQLite query
    // This reduces multiple compilation and I/O roundtrips to the DB into just one execution
