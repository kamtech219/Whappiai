...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // 2. & 3. & 4. Platform Statistics (Users, Sessions, Credits)
    // ⚡ Bolt: Single optimized query combining 6 sequential sub-queries to minimize SQLite I/O
    ...
    const connectedSessions = platformStats.connectedSessions || 0;
    const totalCreditsDeducted = platformStats.totalCreditsDeducted || 0;
    const totalCreditsPurchased = platformStats.totalCreditsPurchased || 0;
