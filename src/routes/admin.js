...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // 2, 3, 4. Bundled Statistics Query (Bolt Optimization ⚡)
    // Bundles multiple independent aggregations into a single DB call
    // reducing JS/C++ boundary crossings and query overhead significantly
