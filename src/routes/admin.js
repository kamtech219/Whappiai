...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Single optimized query for multiple independent aggregate stats using subselects
    // Replaces 6 sequential queries with 1 to reduce SQLite compilation overhead and I/O
    ...
    // Fallbacks for SUMs which can return null if no rows exist
    ...
    const connectedSessions = statsResult.connectedSessions || 0;
    const totalCreditsDeducted = statsResult.totalCreditsDeducted || 0;
    const totalCreditsPurchased = statsResult.totalCreditsPurchased || 0;
