...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Consolidated 6 sequential COUNT/SUM queries into a single SQLite query using subselects.
    // This dramatically reduces statement compilation time and JS/C++ boundary-crossing overhead.
