...
router.get('/stats', requireAdmin, asyncHandler(async (req, res) => {
    ...
    // ⚡ Bolt: Consolidate 6 independent sequential queries into a single SQLite call via subqueries
    // This reduces compilation time and I/O roundtrips, nearly halving the execution time.
