...
// ⚡ Bolt: Cache forbidden words and precompile case-insensitive regex to avoid
// repetitive array allocations and string parsing inside the hot loop.
...
class AIService {
    ...
    static isContentSafe(content) {
        ...
        // ⚡ Bolt: Use precompiled regex to quickly check for forbidden words
