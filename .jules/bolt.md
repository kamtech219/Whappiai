...
## 2024-06-20 - [Consolidate sequential SQLite queries]
**Learning:** In endpoints that require multiple independent aggregation queries (like dashboard stats), executing them sequentially adds unnecessary JS-to-C++ boundary-crossing and I/O overhead.
**Action:** When gathering diverse, independent global statistics from SQLite, bundle multiple aggregations into a single query using subselects to significantly reduce execution time.
